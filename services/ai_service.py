...
Ответь СТРОГО в этом формате (число после 🔥 должно ТОЧНО совпадать со значением в теге KCAL:):
🍽 *{{название}}* (~{{вес}} г)
...
Иначе ответь СТРОГО в этом формате (число после 🔥 должно ТОЧНО совпадать со значением в теге KCAL:):
🍽 *{{название}}* (~{{вес}} г)
